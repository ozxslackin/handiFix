// ==UserScript==
// @name         守护书局人之一键互动（手机顺序版）
// @namespace    https://github.com/ozxslackin/handiFix
// @version      0.1.2
// @description  X站帖子自动化互动（点赞->转发->评论），移动端优化版本
// @author       ozxslackin
// @match        https://x.com/*
// @updateURL    https://github.com/ozxslackin/handiFix/raw/main/auto_interact_mobile.js
// @downloadURL  https://github.com/ozxslackin/handiFix/raw/main/auto_interact_mobile.js
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    style.textContent = `
        ...
        .ozx-comment-form textarea:nth-of-type(1) {
            min-height: 240px;
        }
