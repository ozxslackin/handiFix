...
2. 将 `main.js` 和 `auto_interact.js` 文件的内容复制到 Tampermonkey 中。
...
<img src="https://github.com/ozxslackin/handiFix/blob/main/auto_interact.png" alt="一键互动表单填写说明" style="width: 210px;">
